  ...
  describe 'POST CALLBACK API' do
    ...
    context 'with a message about reminding time after registration' do
      ...
      it 'should reply a message demanding remind-time NG.1' do
        ...
        expect(assigns(:state)).to eq TIME_REMIND_MODE
      end
